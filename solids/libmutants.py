...
# number_of_lattstr = 10
# number_of_atmxchange = 10
# mutants = make_mutants(x, number_of_lattstr, number_of_atmxchange)
# x = mutants[0]
# y = mutants[10]
# write('exchanged.vasp', x, format='vasp')
# write('latticestrained.vasp', y, format='vasp')
